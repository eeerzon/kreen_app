...
class PaketVoteModal {
  static Future<Map<String, dynamic>?> show(BuildContext context, int index, List<Map<String, dynamic>> paketTerbaik, List<Map<String, dynamic>> paketLainnya, Color color, Color bgColor, String id_paket_bw, String currency) async {
                          ...
                          Expanded(
                            child: ElevatedButton(
                              ...
                              onPressed: selectedVotes == null
                                  ? null
                                  : () => Navigator.pop(context, {'id_paket': id_paket, 'counts': counts, 'harga': harga_get,}),
                              child: Text(
                                "Konfirmasi",
