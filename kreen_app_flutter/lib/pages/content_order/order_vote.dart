        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            if (index < orderSuccess.length) {
              ...
              if (item_votes['order_status'] == '0'){
                statusOrder = 'gagal';
              } else if (item_votes['order_status'] == '1'){
                statusOrder = 'selesai';
              } else if (item_votes['order_status'] == '2'){
                statusOrder = 'batal';
              } else if (item_votes['order_status'] == '3'){
                statusOrder = 'menunggu';
              } else if (item_votes['order_status'] == '4'){
                statusOrder = 'refund';
              } else if (item_votes['order_status'] == '20'){
                statusOrder = 'expired';
              } else if (item_votes['order_status'] == '404'){
                statusOrder = 'hidden';
              }
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: (item_votes['order_status'] == '0')
                                          ? Colors.red.shade50
                                          : (item_votes['order_status'] == '1')
                                                ? Colors.green.shade50
                                                : (item_votes['order_status'] == '2') 
                                                  ? Colors.red.shade50
                                                  : (item_votes['order_status'] == '3') 
                                                    ? Colors.orange.shade50
                                                    : (item_votes['order_status'] == '4')
                                                      ? Colors.red.shade50
                                                      : (item_votes['order_status'] == '20')
                                                        ? Colors.red.shade50
                                                        : Colors.black,
                                borderRadius: BorderRadius.circular(8),
                                border: Border.all(
                        ...
                        child: Row(
                          children: [
                              ...
                              child: InkWell(
                                onTap: () {
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          DetailVotePage(id_event: item_votes['id_vote'].toString()),
                                    ),
                                  );
                                },
                                child: Container(
                            ...
                            Expanded(
                              child: InkWell(
                                onTap: () async {
                                  await DetailOrderModal.show(context, item_votes['id_order']);
                                },
                                child: Container(
                                  padding: const EdgeInsets.all(12),
                                  decoration: BoxDecoration(
                            ...
                            Expanded(
                              child: InkWell(
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (_) => WaitingOrderPage(id_order: item_votes['id_order'])),
                                  );
                                },
                                child: Container(
                                  padding: const EdgeInsets.all(12),
