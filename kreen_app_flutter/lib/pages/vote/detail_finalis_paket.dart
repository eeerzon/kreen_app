...
class DetailFinalisPaketPage extends StatefulWidget {
  ...
  DetailFinalisPaketPage({super.key, required this.id_finalis, required this.vote, required this.index, required this.total_detail, required this.id_paket_bw, this.remaining});
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: <Widget>[
                                          SvgPicture.network(
                                            "https://dev.kreenconnect.com/image/icon-vote/${themeName}/dollar-coin.svg",
                                            width: 25,
                                            height: 25,
                                            fit: BoxFit.contain,
                                          ),
