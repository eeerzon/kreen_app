...
class DeskripsiSection_3 extends StatelessWidget {
  ...
  const DeskripsiSection_3({super.key, required this.data, required this.langCode});
...
class DukunganSection_3 extends StatelessWidget {
  final Map<String, dynamic> data;
  final List<dynamic> support;
  final String langCode;
  const DukunganSection_3({super.key, required this.data, required this.support, required this.langCode});
