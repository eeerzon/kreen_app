...
class DeskripsiSection_6 extends StatelessWidget {
  ...
  const DeskripsiSection_6({super.key, required this.data, required this.langCode});
...
class LeaderboardSection_6 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> others = ranking
        ...
        .map((item) {
        final double persen = (item['percent']) / 100;
        return {
          ...item,
          'progress': persen,
        };
...
class DukunganSection_6 extends StatelessWidget {
  final Map<String, dynamic> data;
  final List<dynamic> support;
  final String langCode;
  const DukunganSection_6({super.key, required this.data, required this.support, required this.langCode});
...
Widget buildTopCard({
  ...
  switch (rank) {
    case 1:
      crownImage = 'https://dev.kreenconnect.com/image/gold_crown.gif';
      break;
    case 2:
      crownImage = 'https://dev.kreenconnect.com/image/silver_crown.png';
      break;
    case 3:
      crownImage = 'https://dev.kreenconnect.com/image/bronze_crown.png';
      break;
    default:
      crownImage = '';
  }
