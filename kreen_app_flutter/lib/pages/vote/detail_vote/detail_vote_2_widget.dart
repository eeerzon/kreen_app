...
class LeaderboardSection_2 extends StatelessWidget {
  final List<dynamic> ranking;
  final Map<String, dynamic> data;
  const LeaderboardSection_2({super.key, required this.ranking, required this.data});
...
class DukunganSection_2 extends StatelessWidget {
  final Map<String, dynamic> data;
