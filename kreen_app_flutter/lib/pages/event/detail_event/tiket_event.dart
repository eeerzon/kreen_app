...
import 'package:kreen_app_flutter/helper/get_GeoLocation.dart';
...
class _TiketEventPageState extends State<TiketEventPage> {
  ...
  List<List<String>> ids_order_form_detail = [];
  List<List<String>> ids_order_form_master = [];
                ...
                children: [
                  ...
                  Column(
                    children: List.generate(widget.namas_tiket!.length, (index) {
                      ...
                      hargaFormatted = "Rp " + formatter.format(eventTiket[index]['price'] ?? 0);
                      if (hargaFormatted == "Rp 0") {
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                SvgPicture.network(
                                  "https://dev.kreenconnect.com/image/ticket-white.svg",
                                  width: 17,
                                  height: 17,
                                  fit: BoxFit.contain,
                                ),
                                ...
                                setState(() {
                                  ...
                                  if (_isCheckedList[index]) {
                                    ...
                                    for (int i = 0; i < formTiket.length; i++) {
                                      answerControllers[index][i].text = answerControllers[0][i].text;
                                    ...
                                    for (int i = 0; i < formTiket.length; i++) {
                                      answerControllers[index][i].clear();
                                      answers[index][i] = '';
                                    }
                                  }
                                });
                      ...
                      ...List.generate(formTiket.length, (idx) {
                        ids_order_form_detail[index][idx] = formTiket[idx]['id_order_form_detail'];
                        ids_order_form_master[index][idx] = formTiket[idx]['id_order_form_master'];
                        return Padding(
                          padding: EdgeInsets.only(bottom: 20),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
