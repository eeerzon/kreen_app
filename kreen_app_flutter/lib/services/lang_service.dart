...
class LangService {
  ...
  static Future<Map<String, dynamic>> getJsonDataArray(String langCode, String header, String sub_header) async {
  final String response =
      await rootBundle.loadString("assets/lang/$langCode.json");
  final data = json.decode(response);
  return Map<String, dynamic>.from(data[header][sub_header]);
}
